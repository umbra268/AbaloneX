...
namespace Abalone
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            SCREEN_MANAGER.add_screen(new MenuScreen(GraphicsDevice, ref a, ref b, ref op, ref MarbleModel));
            SCREEN_MANAGER.add_screen(new GameScreen(GraphicsDevice, ref a, ref b, ref op, ref MarbleModel, spriteBatch));
